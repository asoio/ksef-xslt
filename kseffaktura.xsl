      ...
      <div class="section-data">
        ...
        <table class="table-basic">
          <thead>
            <tr>
              <th class="table-basic__header table-basic__header--lp">Lp.</th>
              <xsl:if test="not(tns:Fa/tns:P_13_5)">
